...
import br.ufpa.mestrado.turmas.repository.TurmaRepository;
...
import static br.ufpa.mestrado.turmas.web.rest.TestUtil.createFormattingConversionService;
...
public class TurmaResourceIntTest {
    ...
    private static final Integer DEFAULT_N_ALUNOS = 1;
    private static final Integer UPDATED_N_ALUNOS = 2;
    ...
    public void createTurma() throws Exception {
        ...
        assertThat(testTurma.getnAlunos()).isEqualTo(DEFAULT_N_ALUNOS);
    }
    ...
    public void getAllTurmas() throws Exception {
        ...
        restTurmaMockMvc.perform(get("/api/turmas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nAlunos").value(hasItem(DEFAULT_N_ALUNOS)));
    }
    ...
    public void getTurma() throws Exception {
        ...
        restTurmaMockMvc.perform(get("/api/turmas/{id}", turma.getId()))
            ...
            .andExpect(jsonPath("$.nAlunos").value(DEFAULT_N_ALUNOS));
    }
    ...
    public void updateTurma() throws Exception {
        ...
        assertThat(testTurma.getnAlunos()).isEqualTo(UPDATED_N_ALUNOS);
    }
