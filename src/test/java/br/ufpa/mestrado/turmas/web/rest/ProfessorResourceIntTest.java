...
import br.ufpa.mestrado.turmas.domain.Professor;
import br.ufpa.mestrado.turmas.repository.ProfessorRepository;
...
public class ProfessorResourceIntTest {
    ...
    public void createProfessor() throws Exception {
        ...
        assertThat(testProfessor.getCargaHoraria()).isEqualTo(DEFAULT_CARGA_HORARIA);
    }
    ...
    public void updateProfessor() throws Exception {
        ...
        assertThat(testProfessor.getCargaHoraria()).isEqualTo(UPDATED_CARGA_HORARIA);
    }
